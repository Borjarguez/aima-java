...
public class EightPuzzleDemo {
	...
	private static EightPuzzleBoard board =
...
//		{ 7, 0, 2, 3, 6, 1, 5, 8, 4 } 	// 21 movimientos
	...
	public static void main(String[] args) {
		...
		eightPuzzleGreedyBestFirstManhattanDemo(); // h2
		eightPuzzleNonWeigthedConsistentHeuristicDemo(); // h3
...
//		eightPuzzleAStarPEADemo();
//		eightPuzzleAStarManhattanDemo();
//		eightPuzzleSimulatedAnnealingDemo();
	}

	private static void eightPuzzleAStarNullDemo() {
		System.out.println("\nEightPuzzleAStarNullDemo AStar Search (MisplacedTileHeursitic)");
		try {
	...
	private static void eightPuzzleAStarPEADemo() {
		System.out.println("\nEightPuzzleAStarPEADemo AStar Search (MisplacedTileHeursitic)");
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(random1);
			SearchForActions<EightPuzzleBoard, Action> search = new AStarSearch<>
	...
	// h3
	private static void eightPuzzleNonWeigthedConsistentHeuristicDemo() {
		System.out.println("\nEightPuzzleDemo Greedy Best First Search (ManhattanHeursitic)");
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(boardWithThreeMoveSolution);
			SearchForActions<EightPuzzleBoard, Action> search = new GreedyBestFirstSearch<>
					(new GraphSearch<>(), EightPuzzleFunctions::nonWeigthedConsistentHeuristic);
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			printActions(agent.getActions());
			printInstrumentation(agent.getInstrumentation());
		} catch (Exception e) {
	...
	private static void printActions(List<Action> actions) {
		...
		System.out.println("Nro Actions: " + actions.size());
	}
}